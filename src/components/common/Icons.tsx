...
export const ArchiveBoxIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3.75h3.75M12 7.5h.008v.008H12V7.5zm-3.75 0h.008v.008H8.25V7.5zM3.75 6.75h16.5M3.75 6.75h16.5m-16.5 0V9a2.25 2.25 0 002.25 2.25h12a2.25 2.25 0 002.25-2.25V6.75m-16.5 0h16.5m-16.5 0v-1.5c0-.621.504-1.125 1.125-1.125h14.25c.621 0 1.125.504 1.125 1.125v1.5" />
  </svg>
);
