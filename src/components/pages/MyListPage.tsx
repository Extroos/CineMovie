        ...
        {movies.length === 0 ? (
          ...
          <div style={{
            ...
            {movies.map((item, index) => {
              ...
              const displayTitle = isMovie ? (item as Movie).title : (item as TVShow).name;
              const displayDate = isMovie ? (item as Movie).releaseDate : (item as TVShow).firstAirDate;
                  ...
                  >
                    <div style={{
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onRemove(item.id, isMovie ? 'movie' : 'tv');
                        }}
                        style={{
                          position: 'absolute',
                          top: '8px',
